...
const ContentFourCommunication = () => (
  <div>
    ...
    <p>
      ...
      (independientemente de la posición económica que se tenga, del bagaje
      cultural adquirido o de la jerarquía que tenga en la empresa) es una
    ...
    <p>
      ...
      desgracias varias similares es justo lo que no tienes que hacer. Deja de
    ...
    <p>
      ...
      te ríes, la forma en la que pronuncias cierta letra… Piensa que esas y
      otras particularidades diferentes son las que te hacen únic@ y especial.
      Marcan el carácter, personalidad y es fundamental aceptarlas y amarlas ya
      que son tu esencia. Sólo cuando lo hagas, dejarás atrás la vergüenza, los
    ...
    <p>
      ...
      ¿nunca te ha pasado? Si sabes con antelación que vas a tener que exponer,
      ya estás tardando en ponerte a leer, investigar un poquito, buscar fuentes
    ...
    <p>
      ...
      Lo que sí es de ayuda para ello es que el contenido que vayas a trasmitir,
      independientemente de lo largo o corto que sea, esté muy bien organizado y
      estructurado. ¿Cómo? Lo habitual es hacerlo por puntos, como por ejemplo
    ...
    <p>
      ...
      posible conflicto. Ojo con ello y si estás concentrado puedes modificar y
      sustituir los “peros” por “y”. Mira este ejemplo: “Quiero ir al teatro,
      pero tengo que trabajar”. “Quiero ir al teatro y tengo que trabajar”.
    </p>
  </div>
);

export default ContentFourCommunication;
